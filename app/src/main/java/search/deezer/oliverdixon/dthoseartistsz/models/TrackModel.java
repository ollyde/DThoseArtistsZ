...
import search.deezer.oliverdixon.dthoseartistsz.ui.ListenToAlbum.ViewHolderTrack;

@SuppressWarnings("unused")
public class TrackModel implements RecycleViewDataModel {
    ...
    @Expose
    private ArtistTrackModel artist;
    @SerializedName("type")
    @Expose
    private String type;
    ...
    public ArtistTrackModel getArtist() {
        return artist;
    }

    public void setArtist(ArtistTrackModel artist) {
        this.artist = artist;
    }
    ...
    public int getViewId() {
        return R.layout.viewholder_track;
    }

    @Override
    public Class getViewClass() {
        return ViewHolderTrack.class;
    }
}
